package com.test.sdk.transportdodo.ui;
...
import com.test.sdk.transportdodo.adpter_download.TaskAdapter;
...
public class TaskListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG,"list列表" + new Gson().toJson(list));
        ...
        adapter = new TaskAdapter(controller);
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (controller!=null)controller.unRegister();
    }

    public void  allstop(View view){
        if (controller != null) controller.allStop();
    }
    public void  allstart(View view){
        if (controller != null) controller.allStart();
    }

    public void  alldelete(View view){
        if (controller != null) controller.allCancel();
    }
}
